...
if __name__ == '__main__':
    ...
    for path in open('LOCAL_FILE_PATH'):
        ...
        # copy_and_move_init.req_copy_file(path, '/COPYPATH') # The executed of code if undo '#'
        # copy_and_move_init.req_move_file(path, '/MOVEPATH') # The executed of code if undo '#'
    else:
        print("Job is done!")
